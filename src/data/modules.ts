...
export const modules: Module[] = [
  ...
  },
  {
    ...
    traceNodes: [
      { label: "Conditioned Cue (CS)", description: "A neutral stimulus (here, a colored shape) is perceived. After repeated pairing with an aversive outcome (the US), the amygdala learns to treat this cue as a predictor of threat." },
      { label: "Amygdala: Learning & Expression", description: "The lateral amygdala stores the CS-US association. The central nucleus (CeA) expresses the fear response — triggering autonomic reactions like increased heart rate. During acquisition, this pathway strengthens with each pairing." },
      { label: "vmPFC → Intercalated Cells (ITCs)", description: "During extinction, the ventromedial prefrontal cortex (vmPFC) activates intercalated cells (ITCs) — small inhibitory neurons between the basolateral and central amygdala. ITCs act as a brake, suppressing the CeA fear output without erasing the original association." },
      { label: "Reduced Fear Output / Possible Recovery", description: "With extinction, fear expression decreases — but the original CS-US memory remains intact in the lateral amygdala. If time passes or context changes, the vmPFC brake can weaken and fear may return: this is spontaneous recovery, proving extinction is new learning layered on top of the old memory, not erasure." },
    ],
    explain: {
      whatHappened: "You watched a neutral cue (the CS) become paired with an aversive outcome (the US) during acquisition — classical fear conditioning. Then, during extinction, the cue appeared alone repeatedly and the fear response faded. In a final test after a pause, the cue reappeared — and the fear response may have partially returned. This is spontaneous recovery.",
      whatYourBrainDid: "During acquisition, your amygdala — specifically the lateral nucleus — learned the CS-US association: the cue predicts the aversive event. The central nucleus (CeA) expressed this learned fear through autonomic outputs. During extinction, the vmPFC activated intercalated cells (ITCs), small inhibitory neurons that gate the flow from the basolateral amygdala to the CeA. The ITCs act as a brake on fear expression. Critically, the original fear memory was not erased — the lateral amygdala still holds the CS-US association. Extinction laid down a new, competing memory: 'the CS is now safe.' Spontaneous recovery happens when this extinction memory weakens over time or in a new context, allowing the original fear association to re-emerge.",
      keyPathway: "Acquisition: CS → Lateral amygdala (CS-US learning) → CeA (fear expression). Extinction: CS → vmPFC → ITCs (inhibitory brake) → Suppressed CeA output. The ITCs are the critical intermediary — they allow the brain to suppress a fear response without destroying the underlying memory. Spontaneous recovery occurs when vmPFC/ITC control weakens.",
      nbb302Connection: "This module covers NBB302 material on classical fear conditioning, the amygdala's role in associative threat learning, and extinction as new inhibitory learning rather than memory erasure. The vmPFC → ITC → CeA pathway is a key circuit in modern fear research. Spontaneous recovery demonstrates that extinction does not erase the original CS-US trace — it creates a competing safety memory, which is why conditioned fears can return. This has direct clinical relevance to exposure therapy for anxiety disorders.",
    },
    demoType: "observation",
