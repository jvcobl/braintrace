...
const DistinctionSection = ({ distinctions }: DistinctionSectionProps) => (
  <section>
    ...
    <p className="mt-1.5 text-[12px] sm:text-[13px] text-muted-foreground leading-relaxed">
      Terms that are easy to confuse — and why the difference matters.
    </p>
      ...
      {distinctions.map((d) => (
        ...
        >
          <div className="grid sm:grid-cols-2">
            <div className="p-4 sm:p-5 sm:border-r sm:border-border/50">
              <p className="text-[10px] sm:text-[11px] font-medium uppercase tracking-[0.2em] text-primary/60">
                {d.termA}
              </p>
              <p className="mt-1.5 sm:mt-2 text-[12px] sm:text-[13px] text-foreground/80 leading-relaxed">
                {d.descriptionA}
              </p>
            </div>
            <div className="border-t border-border/50 p-4 sm:p-5 sm:border-t-0">
              <p className="text-[10px] sm:text-[11px] font-medium uppercase tracking-[0.2em] text-primary/60">
                {d.termB}
              </p>
              <p className="mt-1.5 sm:mt-2 text-[12px] sm:text-[13px] text-foreground/80 leading-relaxed">
          ...
          <div className="border-t border-border/50 px-4 py-3 sm:px-5 sm:py-3.5 bg-section-alt">
            <p className="text-[11px] sm:text-[12.5px] text-foreground/70 leading-relaxed">
