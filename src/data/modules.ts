...
export const modules: Module[] = [
  ...
  },
  {
    ...
    traceNodes: [
      { label: "Intense Sudden Stimulus", description: "A loud or sudden sensory event — here, an unexpected visual/auditory interruption — generates a strong, rapid signal entering the auditory and visual pathways." },
      { label: "Cochlear Root Neurons → PnC", description: "For acoustic stimuli, cochlear root neurons send a fast, direct projection to the pontine reticular nucleus (PnC) in the brainstem. This is the core startle circuit — only two to three synapses from stimulus to motor output." },
      { label: "Spinal Motor Neurons → Startle Response", description: "The PnC activates spinal and facial motor neurons, producing the startle reflex: a rapid, involuntary whole-body flinch that occurs before conscious processing." },
      { label: "Amygdala Modulation (BLA → CeA)", description: "The basolateral amygdala (BLA) evaluates the salience and threat value of the stimulus. When the context is primed — e.g., you're already tense or expecting something aversive — the BLA activates the central nucleus (CeA), which feeds back onto the PnC to amplify the startle response. This is fear-potentiated startle." },
    ],
    explain: {
      whatHappened: "You performed a simple reaction-time task under two conditions: a calm baseline and a trial interrupted by a sudden, unexpected visual flash (and optional sound). The interruption was designed to trigger your acoustic startle reflex — a rapid, involuntary response that occurs before you consciously process what happened. Your reaction time likely changed after the interruption, reflecting how the startle circuit disrupted or primed your motor system.",
      whatYourBrainDid: "The sudden stimulus activated your core startle circuit: a fast, direct pathway from sensory input through cochlear root neurons to the pontine reticular nucleus (PnC) and then to spinal motor neurons — producing an involuntary flinch in as few as two to three synapses. Simultaneously, the amygdala evaluated the salience of the event. The basolateral amygdala (BLA) acts as a salience detector — not just a 'fear center' — assessing whether the stimulus matters. When it determines the stimulus is significant, the BLA activates the central nucleus (CeA), which projects back to the PnC and amplifies the startle response. This is the mechanism behind fear-potentiated startle: a primed or anxious state doesn't create a new response, it amplifies the existing one. At a high level, the sudden stimulus also travels a 'low road' — a fast, subcortical route through the thalamus directly to the amygdala — before the slower 'high road' through cortex delivers a conscious, detailed analysis of what happened.",
      keyPathway: "Core startle: Sudden stimulus → Cochlear root neurons → Pontine reticular nucleus (PnC) → Spinal motor neurons → Startle flinch. Modulatory salience path: Auditory/thalamic input → BLA (salience evaluation) → CeA → PnC (amplified startle). The amygdala does not generate the startle — it modulates its intensity based on context and threat appraisal.",
      nbb302Connection: "This module connects to NBB302 material on the acoustic startle reflex, brainstem motor circuits, and amygdala function. The startle circuit illustrates a minimal sensorimotor pathway — fast, reflexive, and largely subcortical. The amygdala's modulatory role demonstrates that it functions as a salience processing center, not solely a fear center, and that emotional states can amplify basic reflexes through top-down modulation of brainstem circuits. The low-road/high-road distinction shows how the brain prioritizes speed over accuracy for potentially threatening stimuli.",
    },
    demoType: "response",
