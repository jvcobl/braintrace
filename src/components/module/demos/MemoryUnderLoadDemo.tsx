  ...
  return (
    ...
    >
      <div className="rounded-lg border border-border bg-card p-6">
        ...
        {feedbackKey && (
          <div className="mt-5">
            <FeedbackCard feedback={trialFeedback[feedbackKey]} onBridgeClick={onNavigate ? () => { const b = {trialFeedback[feedbackKey]}; const t = b.bridge?.toLowerCase(); onNavigate(t?.includes("trace") ? "Trace" : "Explain"); } : undefined} />
