...
export const modules: Module[] = [
  {
    ...
    explain: {
      ...
      whyItMatters: "This module illustrates core concepts of top-down processing and predictive coding in the visual system. The OFC's role in generating rapid object predictions from degraded input connects directly to how cortical feedback shapes perception. The ventral stream and IT cortex pathway is the canonical object recognition route covered in the perception unit.",
    },
  ...
  },
  {
    ...
    explain: {
      ...
      whyItMatters: "This module covers the acoustic startle reflex as a model minimal sensorimotor circuit, the amygdala's role as a salience center (not solely a fear center), and the low-road/high-road distinction for threat processing. The BLA→CeA→PnC pathway illustrates how emotional priming amplifies basic reflexes — the mechanism behind fear-potentiated startle.",
    },
    demoType: "response",
  ...
  },
  {
    ...
    explain: {
      ...
      whyItMatters: "This module covers classical fear conditioning, the amygdala as an associative threat-learning system, and extinction as new inhibitory learning — not erasure. The vmPFC → ITC pathway is central to modern fear research and directly relevant to understanding emotion regulation. Spontaneous recovery demonstrates that conditioned fears persist beneath extinction, which is why exposure therapy must build strong, context-independent safety memories.",
    },
    demoType: "observation",
  ...
  },
  {
    ...
    explain: {
      whatHappened: "You viewed a series of ambiguous figures — including Rubin's vase, a Necker cube, and a duck-rabbit illusion. Each image supports two equally valid perceptions, yet your brain selected one reading instantly every time.",
      whatYourBrainDid: "For each figure, your visual cortex processed identical edges and contours. The prefrontal cortex applied a cognitive heuristic — an automatic shortcut — to lock in one interpretation before you were consciously aware of the alternative. When you switched, the communication pattern between your visual cortex and higher-order regions changed, even though the stimulus on screen remained identical. Across multiple examples, the same mechanism repeated: the brain picks a winner and runs with it.",
      keyPathway: "Retina → V1–V4 (edge/contour extraction, figure-ground, depth) → PFC and ventral stream (interpretation selection and toggle). The toggle occurs at the level of higher-order cortical communication, not at the retina or early visual cortex.",
      whyItMatters: "Seeing the same mechanism operate across multiple different ambiguous figures makes the principle concrete: multistable perception is not a quirk of one image, it is a fundamental feature of how the brain resolves ambiguity. These automatic selection heuristics extend beyond vision to emotion, empathy, and reasoning.",
    },
    demoType: "interactive",
