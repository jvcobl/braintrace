...
export const modules: Module[] = [
  ...
  },
  {
    ...
    explain: {
      whatHappened: "You performed a memory task at two difficulty levels. Under low load, you remembered a short sequence and could ignore distractors. Under high load, the sequence was longer and distractors were present — and your accuracy likely dropped. The task didn't change in kind, only in how much it demanded from your working memory system.",
      whatYourBrainDid: "Your dorsolateral prefrontal cortex (dlPFC) was doing the heavy lifting — actively maintaining items in working memory while suppressing distractors through top-down control. This executive control is metabolically costly: the dlPFC consumes significant energy to keep information online and filter out interference. Under low load, it managed comfortably. Under high load, the dlPFC's limited capacity was exceeded. Top-down control weakened, distractor suppression failed, and irrelevant information began to intrude on your memory. The result: more errors, slower responses, and the subjective feeling of being overwhelmed.",
      keyPathway: "Task demands → dlPFC (working memory maintenance + executive control) → Distractor suppression (top-down filtering) → Under overload: control failure → Performance decline. The key insight is that working memory is not a passive storage bin — it's an active, energy-expensive prefrontal process that breaks down when demand exceeds capacity.",
      nbb302Connection: "This module connects to NBB302 material on working memory, cognitive load theory, and the role of the dlPFC in executive function. The dlPFC's capacity limits explain why multitasking degrades performance and why cognitive overload impairs decision-making. The energy cost of prefrontal control is a recurring theme in the course — executive function is powerful but resource-limited, and when it fails, behavior becomes more stimulus-driven and less goal-directed.",
    },
    demoType: "recall",
